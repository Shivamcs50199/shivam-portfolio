...
const GlobalStyles = () => (
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Scrollbar hidden — was causing right-side vertical line */
    ...
    * { scrollbar-width: none; }
    ...
    /* ── Layout helpers ── */
    .zinc-grid  { grid-template-columns: 1fr 360px; }
  ...
  return (
    <section id="zinc" ref={ref} className="section-pad"
      ...
      <div style={{ maxWidth:"1160px", margin:"0 auto" }}>
        ...
        <div className="zinc-grid" style={{ display:"grid", gridTemplateColumns:"1fr 360px", gap:"64px", alignItems:"center" }}>
