      ...
      <div style={{ maxWidth: "1160px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            ...
            >
              Gluatta started from a very personal observation. I noticed that
              many people around me, including friends and myself at times, go
              through periods of stress, overthinking, self-doubt, and
              emotional pressure. Most wellbeing products approach these
              moments in a calm, clinical, or highly professional way. I wanted
              to explore a different direction — if someone is already feeling
              low, opening another low-energy experience may not help them
              shift their state. Instead, I wanted to create an experience that
              feels energetic, uplifting, visually exciting, and emotionally
              engaging. That's why Gluatta is built around motion, interaction,
              storytelling, and a space-inspired world.
              <br />
              <br />
              The experience begins by asking users to write down whatever is
              weighing on them. Instead of simply saving a note or closing the
              app, the user launches that burden into space. They travel
              through the universe alongside their note, choose a planet, place
              it there, and finally destroy it. The journey ends with a message
              from the universe, creating a feeling of release and completion.
              <br />
              <br />
              Every animation and interaction was intentionally designed to
              serve a purpose — never motion for decoration, but motion that
              creates energy. The space theme, 3D planets, flight sequence,
              destruction ritual, and universe feedback all work together to
              transform a negative emotional moment into a more positive and
              empowering experience.
              <br />
              <br />
              Gluatta is an exploration of how interaction design, motion
              design, storytelling, and technology can be combined to create a
              more engaging approach to emotional wellbeing. It is currently an
              experimental project in progress, designed for anyone who wants a
              different way to process stress, overthinking, and everyday
              emotional burdens.
            </p>
...
const Lightbox = ({ video, onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        <video
          src={video.src} autoPlay loop controls playsInline
        ...
        <button
          ...
          style={{
            ...
            color: C.textSub, fontFamily: "'DM Mono',monospace",
            fontSize: "11px", letterSpacing: "0.08em", padding: "6px 14px", borderRadius: "4px",
          }}
        >
          ESC / CLOSE
        </button>
    ...
    >
      <div style={{ aspectRatio: "16/9", background: C.raised, position: "relative", overflow: "hidden" }}>
        {!error ? (
          <>
            <video
              ref={vRef} src={video.src} autoPlay muted loop playsInline
            ...
            {ready && (
              <div style={{
                ...
                background: hov ? "rgba(0,0,0,0.42)" : "rgba(0,0,0,0)", transition: "background 0.2s",
              }}>
                <div style={{
...
const MotionWork = () => {
  ...
  return (
    <section
      id="motion" ref={ref} className="section-pad"
    ...
    >
      <div style={{ maxWidth: "1160px", margin: "0 auto" }}>
        <motion.div
          ...
          style={{ display: "flex", justifyContent: window.innerWidth <= 768 ? "center" : "space-between", alignItems: "flex-start", marginBottom: "48px", flexWrap: "wrap", gap: "20px" }}
        >
          <div>
        ...
        <motion.div
          variants={fadeUp(0.06)} initial="hidden" animate={inView ? "visible" : "hidden"}
    ...
    >
      <div style={{ maxWidth: "1160px", margin: "0 auto" }}>
        <div className="resume-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "32px" }}>
          ...
          <motion.div variants={fadeUp(0.1)} initial="hidden" animate={inView ? "visible" : "hidden"} className="btn-row" style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
