...
const SectionLabel = ({ children, style }) => (
  <p style={{
    ...
    color: C.textMeta, marginBottom: "16px", ...style,
  }}>{children}</p>
);
  ...
  return (
    <>
      ...
      >
        ...
        >
          {[0,1,2].map(i => (
            <span key={i} style={{ width:"22px", height:"2px", background:C.textSub, borderRadius:"2px",
              transition:"all 0.3s",
              transform: mobileOpen ? (i===0?"rotate(45deg) translateY(7px)":i===2?"rotate(-45deg) translateY(-7px)":"scaleX(0)") : "none",
            }} />
          ))}
        </button>
      </motion.header>
    ...
    >
      <div style={{ maxWidth:"780px" }}>
        ...
        <motion.h1 variants={fadeUp(0.07)} initial="hidden" animate={inView?"visible":"hidden"}
          style={{ fontFamily:"'Sora',sans-serif", fontSize:"clamp(44px,7.5vw,88px)", fontWeight:600, letterSpacing:"-0.04em", lineHeight:1.0, color:C.text }}>
          I design and build
        </motion.h1>

        <motion.div variants={fadeUp(0.12)} initial="hidden" animate={inView?"visible":"hidden"}
          style={{ fontFamily:"'Sora',sans-serif", fontSize:"clamp(44px,7.5vw,88px)", fontWeight:600, letterSpacing:"-0.04em", lineHeight:1.0, color:C.textSub, marginBottom:"32px", minHeight:"1.05em" }}>
        ...
        <motion.p variants={fadeUp(0.17)} initial="hidden" animate={inView?"visible":"hidden"}
          style={{ fontSize:"18px", color:C.textSub, maxWidth:"540px", lineHeight:1.8, fontWeight:400, marginBottom:"40px" }}>
        ...
        {/* Stats */}
        <motion.div variants={fadeUp(0.30)} initial="hidden" animate={inView?"visible":"hidden"}
          ...
          {[["7 yrs","Motion Design"],["React Native","Primary Stack"],["Bangalore","India"]].map(([v,l]) => (
            <div key={l}>
              ...
              <div style={{ fontFamily:"'DM Mono',monospace", fontSize:"11px", color:C.textMeta, letterSpacing:"0.08em", textTransform:"uppercase", marginTop:"4px" }}>{l}</div>
            </div>
          ))}
        </motion.div>
      </div>
...
/* ═══════════════════════════════════════
   ZINC PHONE — object-fit:contain, full UI visible
═══════════════════════════════════════ */
    ...
    <div style={{
      ...
      <div style={{ flex:1, position:"relative", overflow:"hidden", display:"flex", alignItems:"center", justifyContent:"center" }}>
        <video ref={ref} autoPlay muted loop playsInline
          style={{ width:"100%", height:"100%", objectFit:"contain", transition:"opacity 0.26s ease", background:"#07070a" }}
        />
      </div>
      ...
      <div style={{ maxWidth:"1160px", margin:"0 auto" }}>
        ...
        <div className="zinc-grid" style={{ display:"grid", gridTemplateColumns:"1fr 290px", gap:"72px", alignItems:"center" }}>
          ...
          <motion.div variants={fadeUp(0.06)} initial="hidden" animate={inView?"visible":"hidden"}>
            ...
            <p style={{ fontSize:"17px", lineHeight:1.8, color:C.textSub, maxWidth:"480px", marginBottom:"28px" }}>
              A CRED-quality fintech app built from scratch with React Native — custom design system, premium motion, and real product thinking. Every screen designed, every animation implemented, every edge case handled. Not a prototype.
            </p>
      ...
      <div style={{ maxWidth:"1160px", margin:"0 auto" }}>
        ...
        <motion.div variants={fadeUp(0)} initial="hidden" animate={inView?"visible":"hidden"}
          ...
          <div>
            ...
            <h2 style={{ fontFamily:"'Sora',sans-serif", fontSize:"clamp(26px,3.5vw,42px)", fontWeight:600, letterSpacing:"-0.03em", lineHeight:1.15, color:C.text, maxWidth:"520px" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))", gap:"1px", background:C.border }}>
          {cards.map(({ label, body }, i) => (
            <motion.div key={label}
              ...
              style={{ background:C.surface, padding:"32px 28px", transition:"background 0.2s" }}
...
const Lightbox = ({ video, onClose }) => {
  ...
  return (
    <motion.div
      ...
      style={{ position:"fixed", inset:0, zIndex:9000, background:"rgba(0,0,0,0.94)", display:"flex", alignItems:"center", justifyContent:"center", padding:"32px" }}
    >
      <motion.div
...
/* Motion card — direct <video> tag, no HLS needed */
      ...
      <div style={{ maxWidth:"1160px", margin:"0 auto" }}>
        ...
        <motion.div variants={fadeUp(0)} initial="hidden" animate={inView?"visible":"hidden"}
          ...
          <div>
            ...
            <h2 style={{ fontFamily:"'Sora',sans-serif", fontSize:"clamp(26px,3.5vw,42px)", fontWeight:600, letterSpacing:"-0.03em", lineHeight:1.15, color:C.text }}>
...
/* ═══════════════════════════════════════
   RESUME SECTION (between Motion & About)
═══════════════════════════════════════ */
const ResumeSection = () => {
  const ref   = useRef(null);
  const inView = useInView(ref, { once:true, margin:"-8%" });
      ...
      <div style={{ maxWidth:"1160px", margin:"0 auto" }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:"32px" }}>
          ...
          <motion.div variants={fadeUp(0)} initial="hidden" animate={inView?"visible":"hidden"} style={{ maxWidth:"520px" }}>
            ...
            <h2 style={{ fontFamily:"'Sora',sans-serif", fontSize:"clamp(22px,2.8vw,32px)", fontWeight:600, letterSpacing:"-0.03em", lineHeight:1.2, color:C.text, marginBottom:"16px" }}>
    ...
    <section id="about" ref={ref} className="section-pad"
      ...
      <div style={{ maxWidth:"1160px", margin:"0 auto" }}>
        ...
        <div className="two-col" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"72px" }}>
          ...
          <motion.div variants={fadeUp(0)} initial="hidden" animate={inView?"visible":"hidden"}>
            <h2 style={{ fontFamily:"'Sora',sans-serif", fontSize:"clamp(20px,2.6vw,32px)", fontWeight:600, letterSpacing:"-0.03em", lineHeight:1.25, color:C.text, marginBottom:"28px" }}>
    ...
    <section id="contact" ref={ref} className="section-pad"
      ...
      <div style={{ maxWidth:"720px", margin:"0 auto" }}>
        ...
        <motion.h2 variants={fadeUp(0.04)} initial="hidden" animate={inView?"visible":"hidden"}
          style={{ fontFamily:"'Sora',sans-serif", fontSize:"clamp(32px,5vw,58px)", fontWeight:600, letterSpacing:"-0.04em", lineHeight:1.05, color:C.text, marginBottom:"20px" }}>
